	...
	return (
		<Box>
			...
			>
				...
				<Typography sx={{ mb: 3 }}>Rincian Invioice</Typography>
				<Box sx={{ display: "flex" }}>
					<Typography sx={{ mb: 3 }}>No. Invoice</Typography>
					<Typography sx={{ mb: 3 }}>: {invoice_guid}</Typography>
				</Box>
				<Box
					sx={{
						width: "100%",
				...
				>
					...
					<Box sx={{ display: "flex" }}>
						<Typography sx={{ mb: 3 }}>Total Harga</Typography>
						<Typography sx={{ mb: 3 }}>: Rp {invoice.total_prize}</Typography>
					</Box>
				</Box>
						...
						<TableBody>
							{data.map((row, index) => (
								<StyledTableRow key={row.class_name}>
									...
									<StyledTableCell align="center">{row.prize}</StyledTableCell>
								</StyledTableRow>
							))}
						</TableBody>
					</Table>
